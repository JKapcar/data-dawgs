...
95% Monte Carlo intervals. Cash ranks by any-prize rate (positive-profit rate is
also shown); multipliers rank by paid-slot share with fractional tied-cutoff credit;
