...
def source_row(index: int) -> dict:
    ...
    return {
        ...
        "first_name": "Player",
        "last_name": str(index),
        "common_first_name": "Player",
        "football_name": "Player",
        "position": "WR",
        "position_group": "WR",
        ...
        "draft_team": "CLE",
        "esb_id": "",
        "nfl_id": str(1000 + index),
        "smart_id": "",
        "pfr_id": f"Play{index:04d}",
        "pff_id": "",
        "otc_id": "",
        "espn_id": str(2000 + index),
    }
...
class IdentityTests(unittest.TestCase):
    def test_id_is_stable_and_gsis_anchored(self):
        ...
        b = backbone.dd_player_id("00-0036322")
...
class SnapshotTests(unittest.TestCase):
    def envelope(self):
        ...
        meta = {"asset": {
            "id": 1,
            "digest": "sha256:" + "a" * 64,
            "updated_at": "2026-08-09T08:35:37Z",
        }}
    ...
    def test_snapshot_ledger_is_idempotent_for_same_snapshot(self):
        env = self.envelope()
        ledger = backbone.empty_snapshot_ledger("2026-08-14")
        once = backbone.append_snapshot(ledger, env)
