...
const MCP_STAGED = ['dd_find_cfb_games', 'dd_find_cfb_team_games', 'dd_find_cfb_team_periods', 'dd_find_cfb_latest_team_periods', 'dd_find_cfb_historical_market', 'dd_get_cfb_model_card', 'dd_get_cfb_rating_system', 'dd_rank_cfb_teams', 'dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path', 'dd_find_cfb_record_divergence', 'dd_get_cfb_model_disagreement', 'dd_get_cfb_model_receipt_status'];
const MCP_ENDPOINT = {
...
const SURFACES = [
  ...
  { id: 'pound', name: 'The Pound model and calculator workbench', page: '/pound.html',
    machine: [{ kind: 'json', url: '/data/pound-tools.json', status: 'live', covers: 'complete NFL tool inventory plus the College Football roadmap with evidence-backed lifecycle state; no candidate CFB MCP tool is callable' },
              ...
              { kind: 'json', url: '/data/cfb-team-week-latest.json', status: 'live', covers: '230 compact latest team-period rows selected exactly from the results-only team-week snapshot; no current-2026 or predictive claim' },
...
for (const name of ['nfl-schedule.json', 'model-receipts.json', '538-classic.json',
  'cfb-schedule.json', 'cfb-team-game.json', 'cfb-team-week.json', 'cfb-team-week-latest.json', 'cfb-teams.json', 'cfb-record-divergence.json', 'cfb-market.json', 'cfb-elo.json', 'cfb-model-cards.json',
