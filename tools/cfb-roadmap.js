...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-public-outputs', name: 'Compact Public CFB Outputs',
    ...
    delivery_note: 'Partially implemented with compact rating profiles, exact latest completed FBS team games and exact latest-period team rows carrying overall and non-authoritative conference records; both latest surfaces have bounded staged readers. Richer team-week metrics and model grades remain future outputs.',
