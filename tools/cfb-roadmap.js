...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-season-sim', name: 'Schedule Path Simulator',
    ...
    candidate_mcp_tools: ['simulate_cfb_season'],
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'building', on: ROADMAP_AS_OF, note: 'Implemented and evaluated team profile, comparison and hypothetical Elo matchup tools locally; all remain staged and non-callable in production.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json'],
    delivery_note: 'Three source-backed CFB tools are implemented locally and staged, including the published Elo matchup transform. Production still has 26 live tools; deployment requires a separate approved Worker release.',
    ...
    candidate_mcp_tools: ['dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup',
