...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-fraud-detector', name: 'Overrated / Underrated Team Detector',
    ...
    candidate_mcp_tools: ['find_cfb_overrated_teams', 'find_cfb_underrated_teams'],
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'building', on: ROADMAP_AS_OF, note: 'Implemented and evaluated team profile, comparison, hypothetical Elo matchup and exact hypothetical schedule-path tools locally; all remain staged and non-callable in production.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json'],
    delivery_note: 'Four source-backed CFB tools are implemented locally and staged, including exact matchup and schedule-path calculations over the published Elo transform. Production still has 26 live tools; deployment requires a separate approved Worker release.',
    ...
    candidate_mcp_tools: ['dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path',
