...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-team-game', name: 'Canonical CFB Team-Game Dataset',
    ...
    delivery_evidence: ['/data/cfb-team-game.json', '/scripts/cfb_team_results.py', '/tests/test_cfb_team_results.py', '/work/mcp-block.js'],
    delivery_note: 'Partially implemented with observed schedule/result facts only and a bounded exact-team game-history reader staged locally. EPA, success, explosiveness, havoc and garbage-time fields still require canonical play-by-play.',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation'], roadmap_step: 1,
  ...
  idea({ id: 'cfb-public-outputs', name: 'Compact Public CFB Outputs',
    ...
    lifecycle_history: [
      { status: 'idea', on: ROADMAP_AS_OF, note: 'Entered The Pound from the 2026-08-08 CFB roadmap.' },
      { status: 'building', on: ROADMAP_AS_OF, note: 'Published compact 136-team rating profiles plus 230 results-only latest-period team rows, each locked to its exact source snapshot.' },
    ],
    delivery_evidence: ['/data/cfb-teams.json', '/data/cfb-team-week-latest.json', '/scripts/cfb_team_profiles.py', '/scripts/cfb_team_results.py', '/tests/test_cfb_team_profiles.py', '/tests/test_cfb_team_results.py'],
    delivery_note: 'Partially implemented with compact rating profiles and exact latest-period team rows. A latest-game feed, richer team-week metrics and model grades remain future outputs.',
