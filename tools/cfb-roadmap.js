...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'building', on: ROADMAP_AS_OF, note: 'Implemented and evaluated dd_cfb_team_profile plus dd_compare_cfb_teams locally over compact dated profiles; both remain staged and non-callable in production.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json'],
    delivery_note: 'Two source-backed CFB read tools are implemented locally and staged. Production still has 26 live tools; deployment requires a separate approved Worker release.',
    ...
    candidate_mcp_tools: ['dd_cfb_team_profile', 'dd_compare_cfb_teams', 'get_cfb_game_projection',
