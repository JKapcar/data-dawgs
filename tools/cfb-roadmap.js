...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-ratings-registry', name: 'CFB Ratings Registry',
    ...
    delivery_note: 'The registry contract is live with one independent, retrodictive Elo system, and a bounded ranking/conference reader is staged locally. CFBD systems and market context remain future additions; one system is not a consensus.',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation', 'high-priority'],
    ...
    candidate_mcp_tools: ['dd_rank_cfb_teams'],
  ...
  idea({ id: 'cfb-team-week', name: 'CFB Team-Week Analytical Layer',
    ...
    delivery_evidence: ['/data/cfb-team-week.json', '/scripts/cfb_team_results.py', '/tests/test_cfb_team_results.py', '/work/mcp-block.js'],
    delivery_note: 'Partially implemented. The live surface contains observed results and season-to-date scoring/record facts, with a bounded exact-team period-history reader staged locally; play, opponent-adjusted and market-performance metrics remain unavailable.',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation', 'high-priority'],
    priority: 'high', roadmap_step: 1,
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'building', on: ROADMAP_AS_OF, note: 'Implemented and evaluated canonical game, results-only team-game and team-period, and historical market lookup, generated model-card governance, bounded single-system rankings, team profile, comparison, hypothetical Elo matchup, exact hypothetical schedule-path, descriptive record-divergence, blocked model-disagreement and prospective-receipt status tools locally; all remain staged and non-callable in production.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json',
      '/data/cfb-record-divergence.json', '/data/cfb-record-divergence-validation.json', '/data/cfb-market.json',
      '/data/cfb-model-cards.json'],
    delivery_note: 'Thirteen source-backed CFB tools are implemented locally and staged, including canonical game, results-only team-game and team-period, and no-CLV historical market lookup, generated model-card governance, bounded single-system rankings, exact matchup and schedule-path calculations, plus no-label divergence, blocked-study and prospective-receipt status readers. Production still has 26 live tools; deployment requires a separate approved Worker release.',
    ...
    candidate_mcp_tools: ['dd_find_cfb_games', 'dd_find_cfb_team_games', 'dd_find_cfb_team_periods', 'dd_find_cfb_historical_market', 'dd_get_cfb_model_card', 'dd_rank_cfb_teams', 'dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path', 'dd_find_cfb_record_divergence',
