...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-team-week', name: 'CFB Team-Week Analytical Layer',
    ...
    deterministic_tool_potential: 'Yes — team profiles and comparisons become deterministic reads.',
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    candidate_mcp_tools: ['dd_find_cfb_games', 'dd_find_cfb_historical_market', 'dd_get_cfb_model_card', 'dd_rank_cfb_teams', 'dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path', 'dd_find_cfb_record_divergence',
