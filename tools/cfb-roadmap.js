...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-disagreement-lab', name: 'CFB Model Disagreement Lab',
    ...
    candidate_mcp_tools: ['get_cfb_model_disagreement', 'find_cfb_disagreements'],
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'building', on: ROADMAP_AS_OF, note: 'Implemented and evaluated team profile, comparison, hypothetical Elo matchup, exact hypothetical schedule-path and descriptive record-divergence tools locally; all remain staged and non-callable in production.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json',
      '/data/cfb-record-divergence.json', '/data/cfb-record-divergence-validation.json'],
    delivery_note: 'Five source-backed CFB tools are implemented locally and staged, including exact matchup and schedule-path calculations plus a no-label record-divergence explorer. Production still has 26 live tools; deployment requires a separate approved Worker release.',
