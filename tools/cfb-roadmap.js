...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-market', name: 'CFB Market Dataset',
    ...
    lifecycle_history: [
      { status: 'idea', on: ROADMAP_AS_OF, note: 'Entered The Pound from the 2026-08-08 CFB roadmap.' },
      { status: 'building', on: ROADMAP_AS_OF, note: 'Published book-identified historical prices; observation time remains unknown.' },
      { status: 'building', on: ROADMAP_AS_OF, note: 'Activated the immutable 24-hour pregame capture cron and public receipt export; first observations depend on eligible 2026 events entering the window.' },
    ],
  ...
  idea({ id: 'cfb-public-outputs', name: 'Compact Public CFB Outputs',
    ...
    delivery_note: 'Partially implemented with compact rating profiles, exact latest completed FBS team games and exact latest-period team rows carrying overall and non-authoritative conference records; both latest surfaces have bounded production MCP readers. Richer team-week metrics and model grades remain future outputs.',
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'live', on: ROADMAP_AS_OF, note: 'Deployed sixteen validated, bounded, read-only CFB tools to the production toto Worker as version 4de01c9d-cff6-4234-9be1-3b93df6f49e7.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json',
    ...
    rationale: 'The production product layer: read-only tools that call deterministic Data Dawgs computation, with the AI doing orchestration and explanation — sixteen CFB tools now run alongside the existing 26-tool registry, and future names remain gated on their underlying capability.',
    ...
    validation_requirement: 'A candidate tool goes live only after its underlying computation is built, tested and deployed — the first sixteen passed that gate; remaining reserved names stay non-callable.',
