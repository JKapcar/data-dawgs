 ...
 * on a canonical idea, inside a component of one, or as a governance principle.
 * The consolidation is reported in build output and asserted by
 * work/test-pound-contracts.js — an idea is never silently dropped.
 *
 * Consumed by tools/build-data.js into /data/pound-tools.json.
 */
'use strict';

const ROADMAP_AS_OF = '2026-08-08';

const CFB_RECOMMENDATION_CLASSES = {
...
const CFB_LIFECYCLE = {
  statuses: ['idea', 'evaluating', 'planned', 'building', 'live', 'deferred', 'graveyard', 'revived'],
  happy_path: 'idea → evaluating → planned → building → live',
  alternate_exits: ['idea/evaluating/live → deferred', 'any → graveyard', 'graveyard → revived'],
  ...
  graveyard_postmortem_fields: [
    'original_hypothesis', 'intended_outcome', 'recommendation_when_proposed', 'why_attempted',
    'implementation_version', 'data_used', 'validation_design', 'expected_benefit', 'actual_result',
    'performance_vs_baseline', 'cost_complexity_maintenance', 'known_failure_modes', 'reason_retired',
    'date_retired', 'receipts', 'lessons_learned', 'revival_conditions', 'links', 'lifecycle_history',
  ],
  revival_question: 'What would have to become true for us to dig this Dawg back up?',
};

const CFB_ROADMAP_STEPS = [
  { step: 1, title: 'Foundation / canonical CFB data',
    idea_ids: ['cfb-sportsdataverse', 'cfb-cfbd', 'cfb-games', 'cfb-plays', 'cfb-team-game',
      'cfb-player-game', 'cfb-rosters', 'cfb-market', 'cfb-talent-dataset', 'cfb-team-week', 'cfb-public-outputs'] },
  { step: 2, title: 'Ratings registry', idea_ids: ['cfb-ratings-registry', 'cfb-elo'] },
  { step: 3, title: 'Model disagreement + receipts', idea_ids: ['cfb-disagreement-lab', 'cfb-model-receipts'] },
  { step: 4, title: 'Model diversity / consensus', idea_ids: ['cfb-consensus-engine'] },
  { step: 5, title: 'Fourth-down engine', idea_ids: ['cfb-fourth-down'] },
  { step: 6, title: 'Talent / recruiting / portal',
    idea_ids: ['cfb-portal-flow', 'cfb-acquisition-network', 'cfb-returning-production', 'cfb-talent-composite'] },
  { step: 7, title: 'Fraud Detector', idea_ids: ['cfb-fraud-detector'] },
  { step: 8, title: 'Opponent-adjusted unit ratings + matchup engine', idea_ids: ['cfb-unit-ratings', 'cfb-matchup-fingerprints'] },
  { step: 9, title: 'Season / playoff path simulator', idea_ids: ['cfb-season-sim'] },
  { step: 10, title: 'Coaching decision scorecards', idea_ids: ['cfb-coaching-scorecards'] },
  { step: 11, title: 'Data Dawgs predictive model', idea_ids: ['cfb-dd-power-rating'] },
  { step: 12, title: 'Experimental challenger models', idea_ids: ['cfb-challenger-lab'] },
];

const CFB_GOVERNANCE = [
  { id: 'cfb-gov-source-provenance', name: 'Source Provenance', source_heading: 'Source Provenance',
    ...
    applies_to: 'every CFB idea', related_ideas: ['cfb-sportsdataverse', 'cfb-cfbd', 'cfb-public-outputs'] },
  { id: 'cfb-gov-snapshotting', name: 'Snapshotting / Receipts', source_heading: 'Snapshotting / Receipts',
    ...
    applies_to: 'every CFB forecast or model output', related_ideas: ['cfb-model-receipts'] },
  { id: 'cfb-gov-model-cards', name: 'Model Cards', source_heading: 'Model Cards',
    ...
    applies_to: 'every CFB model promoted past the lab', related_ideas: ['cfb-dd-power-rating', 'cfb-xrepa', 'cfb-challenger-lab'] },
  { id: 'cfb-gov-baseline', name: 'Baseline Requirement', source_heading: 'Baseline Requirement',
    ...
    applies_to: 'every CFB model', related_ideas: ['cfb-elo', 'cfb-challenger-lab', 'cfb-dd-power-rating'] },
  { id: 'cfb-gov-incremental', name: 'Incremental Information Test', source_heading: 'Incremental Information Test',
    ...
    applies_to: 'every CFB model and feature family', related_ideas: ['cfb-context-lab', 'cfb-availability-lab', 'cfb-challenger-lab'] },
  { id: 'cfb-gov-correlation', name: 'Correlation Awareness', source_heading: 'Correlation Awareness',
    ...
    applies_to: 'every multi-model CFB surface', related_ideas: ['cfb-consensus-engine', 'cfb-disagreement-lab'] },
  { id: 'cfb-gov-uncertainty', name: 'Uncertainty', source_heading: 'Uncertainty',
    ...
    applies_to: 'every CFB output', related_ideas: ['cfb-nil', 'cfb-counterfactual', 'cfb-fraud-detector'] },
];

/* Shorthand builder: fills the fields every roadmap idea shares. */
const idea = o => Object.assign({
  kind: 'roadmap-idea',
...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-sportsdataverse', name: 'SportsDataverse Bulk-Data Ingestion',
    ...
    related_ideas: ['cfb-cfbd', 'cfb-games', 'cfb-plays'], governance: ['cfb-gov-source-provenance'],
    tags: ['CFB', 'DATA-PIPE', 'FOUNDATION', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-cfbd', name: 'CFBD Enrichment / Model Ingestion',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation', 'high-priority'],
    priority: 'high', roadmap_step: 1,
    source_headings: ['CFBD enrichment/model ingestion'],
    ...
    dependencies: [], related_ideas: ['cfb-sportsdataverse', 'cfb-ratings-registry', 'cfb-talent-dataset'],
  ...
  idea({ id: 'cfb-games', name: 'Canonical CFB Games',
    ...
    delivery_note: 'Live for the completed 2025 season with a staged bounded MCP game finder. The upstream 2026 schedule has not been published yet.',
    ...
    candidate_mcp_tools: ['dd_find_cfb_games'],
    ...
    dependencies: ['cfb-sportsdataverse'], related_ideas: ['cfb-plays', 'cfb-market'],
    governance: ['cfb-gov-source-provenance'], tags: ['CFB', 'DATA-PIPE', 'FOUNDATION'] }),

  idea({ id: 'cfb-plays', name: 'Canonical CFB Play-by-Play',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation'], roadmap_step: 1,
    source_headings: ['Canonical CFB Play-by-Play'],
    ...
    dependencies: ['cfb-sportsdataverse', 'cfb-games'], related_ideas: ['cfb-team-week', 'cfb-fourth-down'],
    governance: ['cfb-gov-source-provenance'], tags: ['CFB', 'DATA-PIPE', 'FOUNDATION'] }),
  ...
  idea({ id: 'cfb-team-game', name: 'Canonical CFB Team-Game Dataset',
    ...
    delivery_evidence: ['/data/cfb-team-game.json', '/data/cfb-games-latest.json', '/scripts/cfb_team_results.py', '/tests/test_cfb_team_results.py', '/work/mcp-block.js'],
    delivery_note: 'Partially implemented with observed schedule/result facts, a compact latest-completed-game row per FBS team, and a bounded exact-team game-history reader staged locally. EPA, success, explosiveness, havoc and garbage-time fields still require canonical play-by-play.',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation'], roadmap_step: 1,
    ...
    candidate_mcp_tools: ['dd_find_cfb_team_games'],
    ...
    dependencies: ['cfb-plays', 'cfb-games'], related_ideas: ['cfb-team-week', 'cfb-player-game'],
    tags: ['CFB', 'DATA-PIPE', 'FOUNDATION'] }),

  idea({ id: 'cfb-player-game', name: 'Canonical CFB Player-Game Dataset',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation'], roadmap_step: 1,
    source_headings: ['CFB Player-Game Dataset'],
    ...
    dependencies: ['cfb-plays', 'cfb-rosters'], related_ideas: ['cfb-cpoe', 'cfb-xrepa', 'cfb-qbr'],
    tags: ['CFB', 'DATA-PIPE', 'FOUNDATION'] }),

  idea({ id: 'cfb-rosters', name: 'CFB Rosters / Identity Resolution',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation'], roadmap_step: 1,
    source_headings: ['CFB Rosters / Identity Resolution'],
    ...
    dependencies: ['cfb-sportsdataverse', 'cfb-cfbd'], related_ideas: ['cfb-portal-flow', 'cfb-acquisition-network', 'cfb-player-game'],
    tags: ['CFB', 'DATA-PIPE', 'FOUNDATION'] }),
  ...
  idea({ id: 'cfb-market', name: 'CFB Market Dataset',
    ...
    delivery_evidence: ['/data/cfb-market.json', '/scripts/cfb_market.py', '/tests/test_cfb_market.py',
      '/work/mcp-block.js', '/work/test-mcp.mjs'],
    delivery_note: 'Partially implemented. Historical book prices are live with explicit unknown timing and have a staged no-CLV MCP reader; the timestamped prospective Worker collector still needs activation.',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation'], roadmap_step: 1,
    ...
    candidate_mcp_tools: ['dd_find_cfb_historical_market'],
    ...
    dependencies: ['cfb-games'], related_ideas: ['cfb-ratings-registry', 'cfb-model-receipts', 'cfb-prediction-markets'],
  ...
  idea({ id: 'cfb-ratings-registry', name: 'CFB Ratings Registry',
    ...
    delivery_evidence: ['/data/cfb-ratings.json', '/scripts/cfb_ratings_registry.py', '/tests/test_cfb_ratings_registry.py', '/work/mcp-block.js'],
    delivery_note: 'The registry contract is live with one independent, retrodictive Elo system. Bounded registry metadata and ranking/conference readers are staged locally. CFBD systems and market context remain future additions; one system is not a consensus.',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation', 'high-priority'],
    ...
    candidate_mcp_tools: ['dd_get_cfb_rating_system', 'dd_rank_cfb_teams'],
  ...
  idea({ id: 'cfb-talent-dataset', name: 'CFB Talent Dataset',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation'], roadmap_step: 1,
    source_headings: ['CFB Talent Dataset'],
    ...
    dependencies: ['cfb-cfbd', 'cfb-rosters'], related_ideas: ['cfb-returning-production', 'cfb-portal-flow', 'cfb-talent-composite'],
  ...
  idea({ id: 'cfb-team-week', name: 'CFB Team-Week Analytical Layer',
    ...
    lifecycle_history: [
      { status: 'idea', on: ROADMAP_AS_OF, note: 'Entered The Pound from the 2026-08-08 CFB roadmap.' },
      { status: 'building', on: ROADMAP_AS_OF, note: 'Published results-only team-period history and an exact compact latest row per team with opponent, venue, record and scoring facts. Advanced analytical metrics remain gated.' },
    ],
    ...
    delivery_note: 'Partially implemented. The live surfaces contain observed results, season-to-date scoring/record facts and a compact exact latest-period row per team, with a bounded exact-team period-history reader staged locally; play, opponent-adjusted and market-performance metrics remain unavailable.',
    category: 'foundation', recommendation: 'build', recommendation_modifiers: ['foundation', 'high-priority'],
    priority: 'high', roadmap_step: 1,
    ...
    candidate_mcp_tools: ['dd_find_cfb_team_periods'],
    ...
    dependencies: ['cfb-plays', 'cfb-team-game', 'cfb-market'], related_ideas: ['cfb-unit-ratings', 'cfb-fraud-detector', 'cfb-ratings-registry'],
    governance: ['cfb-gov-uncertainty'], tags: ['CFB', 'FOUNDATION', 'MODEL', 'HIGH-PRIORITY'] }),
  ...
  idea({ id: 'cfb-public-outputs', name: 'Compact Public CFB Outputs',
    ...
    lifecycle_history: [
      { status: 'idea', on: ROADMAP_AS_OF, note: 'Entered The Pound from the 2026-08-08 CFB roadmap.' },
      { status: 'building', on: ROADMAP_AS_OF, note: 'Published compact 136-team rating profiles, 136 latest completed FBS team games and 230 results-only latest-period team rows, each locked to its exact source snapshot.' },
    ],
    delivery_evidence: ['/data/cfb-teams.json', '/data/cfb-games-latest.json', '/data/cfb-team-week-latest.json', '/scripts/cfb_team_profiles.py', '/scripts/cfb_team_results.py', '/tests/test_cfb_team_profiles.py', '/tests/test_cfb_team_results.py'],
    delivery_note: 'Partially implemented with compact rating profiles, exact latest completed FBS team games and exact latest-period team rows. Richer team-week metrics and model grades remain future outputs.',
    ...
    candidate_mcp_tools: ['dd_find_cfb_latest_team_periods'],
    ...
    dependencies: ['cfb-games', 'cfb-team-week', 'cfb-ratings-registry'], related_ideas: ['cfb-sqlite-explorer', 'cfb-mcp-layer'],
    governance: ['cfb-gov-source-provenance'], tags: ['CFB', 'DATA-PIPE', 'FOUNDATION', 'API'] }),

  idea({ id: 'cfb-raw-pipeline', name: 'Full Offline-Reprocessable Raw Pipeline',
    category: 'delivery', recommendation: 'lab', recommendation_modifiers: ['defer-until-justified'],
    source_headings: ['Full offline-reprocessable upstream/raw pipeline'],
    ...
    dependencies: ['cfb-sportsdataverse'], related_ideas: ['cfb-public-outputs'],
    revisit_conditions: ['A real reprocessing need the canonical layer cannot answer', 'Upstream reliability degrades', 'Storage/maintenance cost drops materially'],
    tags: ['CFB', 'DATA-PIPE', 'EXPERIMENTAL'] }),

  idea({ id: 'cfb-sqlite-explorer', name: 'Static SQLite / Browser-Queryable Explorer',
    category: 'delivery', recommendation: 'lab',
    source_headings: ['Static SQLite / browser-queryable exploratory database'],
    ...
    dependencies: ['cfb-public-outputs'], related_ideas: ['cfb-public-outputs'],
    tags: ['CFB', 'DATA-PIPE', 'EXPERIMENTAL'] }),
  ...
  idea({ id: 'cfb-disagreement-lab', name: 'CFB Model Disagreement Lab',
    ...
    delivery_evidence: ['/data/cfb-disagreement.json', '/scripts/cfb_disagreement.py', '/tests/test_cfb_disagreement.py',
      '/work/mcp-block.js', '/work/test-mcp.mjs'],
    delivery_note: 'The lab artifact is live and its aggregate evidence has a staged read-only MCP reader, but the headline question remains blocked by historical prices without observation timestamps. The tool returns the blocker rather than a winner or blend.',
    ...
    candidate_mcp_tools: ['dd_get_cfb_model_disagreement', 'find_cfb_disagreements'],
    ...
    dependencies: ['cfb-ratings-registry'], related_ideas: ['cfb-consensus-engine', 'cfb-model-receipts'],
  ...
  idea({ id: 'cfb-model-receipts', name: 'CFB Model Receipts / Historical Grading',
    ...
    delivery_evidence: ['/data/cfb-model-receipts.json', '/scripts/cfb_model_receipts.py', '/tests/test_cfb_model_receipts.py',
      '/work/mcp-block.js', '/work/test-mcp.mjs'],
    delivery_note: 'Receipt infrastructure is implemented, the public ledger is honestly empty, and a staged read-only status tool reports that state without manufacturing grades. The first actual row still waits on a 2026 scheduled game and a forecast frozen before kickoff.',
    category: 'model-validation', recommendation: 'build', recommendation_modifiers: ['high-priority'],
    priority: 'high', roadmap_step: 3,
    ...
    candidate_mcp_tools: ['dd_get_cfb_model_receipt_status', 'get_cfb_model_grades'],
    ...
    dependencies: ['cfb-ratings-registry', 'cfb-market'], related_ideas: ['cfb-disagreement-lab', 'cfb-consensus-engine'],
    governance: ['cfb-gov-snapshotting'],
    ...
    tags: ['CFB', 'MODEL-RISK', 'FORECASTING', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-consensus-engine', name: 'CFB Model Diversity / Consensus Engine',
    category: 'model-validation', recommendation: 'build', recommendation_modifiers: ['high-priority', 'decision-engine'],
    priority: 'high', roadmap_step: 4,
    source_headings: ['Model Diversity / Consensus Engine'],
    ...
    candidate_mcp_tools: ['get_cfb_consensus'],
    ...
    dependencies: ['cfb-model-receipts', 'cfb-disagreement-lab'], related_ideas: ['cfb-ratings-registry'],
    governance: ['cfb-gov-correlation', 'cfb-gov-incremental'],
  ...
  idea({ id: 'cfb-elo', name: 'Continuous Elo / Glicko Rating',
    ...
    candidate_mcp_tools: ['dd_get_cfb_model_card'],
    ...
    dependencies: ['cfb-games'], related_ideas: ['cfb-ratings-registry', 'cfb-challenger-lab'],
    governance: ['cfb-gov-baseline'], tags: ['CFB', 'MODEL', 'FORECASTING'] }),

  idea({ id: 'cfb-unit-ratings', name: 'Opponent-Adjusted Unit Ratings',
    category: 'model-validation', recommendation: 'build', recommendation_modifiers: ['high-priority'],
    priority: 'high', roadmap_step: 8,
    source_headings: ['Opponent-Adjusted Unit Ratings'],
    ...
    dependencies: ['cfb-plays', 'cfb-team-week'], related_ideas: ['cfb-matchup-fingerprints', 'cfb-ratings-registry'],
    governance: ['cfb-gov-incremental'], tags: ['CFB', 'MODEL', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-dd-power-rating', name: 'Data Dawgs Predictive Power Rating',
    category: 'model-validation', recommendation: 'build', recommendation_modifiers: ['eventual'],
    priority: 'eventual', roadmap_step: 11,
    source_headings: ['Data Dawgs Predictive Power Rating'],
    ...
    dependencies: ['cfb-team-week', 'cfb-model-receipts', 'cfb-ratings-registry', 'cfb-talent-dataset'],
    related_ideas: ['cfb-challenger-lab', 'cfb-elo'],
    governance: ['cfb-gov-baseline', 'cfb-gov-incremental', 'cfb-gov-model-cards'],
    tags: ['CFB', 'MODEL', 'FORECASTING'] }),

  idea({ id: 'cfb-challenger-lab', name: 'Challenger Model Laboratory',
    category: 'model-validation', recommendation: 'lab', roadmap_step: 12,
    source_headings: ['Deep/Trajectory Model', 'XGBoost / Other ML Challenger Models'],
    components: [
      { name: 'Deep / trajectory model', source_heading: 'Deep/Trajectory Model',
      ...
      { name: 'XGBoost / other ML challengers', source_heading: 'XGBoost / Other ML Challenger Models',
    ...
    dependencies: ['cfb-team-week', 'cfb-model-receipts'], related_ideas: ['cfb-dd-power-rating', 'cfb-elo'],
    governance: ['cfb-gov-baseline', 'cfb-gov-incremental', 'cfb-gov-model-cards'],
    ...
    tags: ['CFB', 'MODEL', 'EXPERIMENTAL'] }),

  idea({ id: 'cfb-training-pack', name: 'CFBD Model Training Pack / Educational Resources',
    category: 'model-validation', recommendation: 'lab', recommendation_modifiers: ['reference'],
    source_headings: ['CFBD Model Training Pack / educational modeling resources'],
    ...
    related_ideas: ['cfb-dd-power-rating', 'cfb-challenger-lab'],
    tags: ['CFB', 'EXPERIMENTAL'] }),

  /* ---------- Talent / recruiting / portal ---------- */

  idea({ id: 'cfb-portal-flow', name: 'Transfer Portal Flow Network & Net Flow',
    category: 'talent-portal', recommendation: 'build', recommendation_modifiers: ['high-priority'],
    priority: 'high', roadmap_step: 6,
    source_headings: ['Transfer Portal Flow Network', 'Portal Net Flow'],
    components: [
      { name: 'Portal flow network', source_heading: 'Transfer Portal Flow Network',
      ...
      { name: 'Portal net flow', source_heading: 'Portal Net Flow',
    ...
    dependencies: ['cfb-rosters', 'cfb-talent-dataset'], related_ideas: ['cfb-acquisition-network', 'cfb-counterfactual', 'cfb-talent-composite'],
    governance: ['cfb-gov-incremental'],
    ...
    tags: ['CFB', 'PORTAL', 'NETWORK', 'TALENT', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-acquisition-network', name: 'Player Acquisition Network',
    category: 'talent-portal', recommendation: 'build', roadmap_step: 6,
    source_headings: ['Recruiting Acquisition Network', 'Player Acquisition Graph'],
    components: [
      { name: 'Recruiting acquisition network', source_heading: 'Recruiting Acquisition Network',
      ...
      { name: 'Unified player acquisition graph', source_heading: 'Player Acquisition Graph',
    ...
    dependencies: ['cfb-rosters', 'cfb-talent-dataset'], related_ideas: ['cfb-portal-flow', 'cfb-talent-composite'],
    ...
    tags: ['CFB', 'RECRUITING', 'NETWORK', 'TALENT'] }),

  idea({ id: 'cfb-returning-production', name: 'Returning Production',
    category: 'talent-portal', recommendation: 'build', recommendation_modifiers: ['high-priority'],
    priority: 'high', roadmap_step: 6,
    source_headings: ['Returning Production'],
    ...
    dependencies: ['cfb-talent-dataset', 'cfb-rosters'], related_ideas: ['cfb-talent-composite', 'cfb-counterfactual'],
    governance: ['cfb-gov-incremental'], tags: ['CFB', 'TALENT', 'FORECASTING', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-talent-composite', name: 'Recruiting / Talent Composite',
    category: 'talent-portal', recommendation: 'build', roadmap_step: 6,
    source_headings: ['Recruiting Composite / Talent Composite'],
    ...
    dependencies: ['cfb-talent-dataset'], related_ideas: ['cfb-returning-production', 'cfb-portal-flow'],
    governance: ['cfb-gov-incremental'], tags: ['CFB', 'TALENT', 'RECRUITING'] }),

  idea({ id: 'cfb-recruiting-scrape', name: 'Raw 247 / On3 / Rivals Scraping',
    category: 'talent-portal', recommendation: 'avoid-initially',
    source_headings: ['Raw 247 / On3 / Rivals Scraping'],
    ...
    related_ideas: ['cfb-talent-composite', 'cfb-talent-dataset'],
    revisit_conditions: ['A lawful structured feed or licensing route appears', 'A demonstrated question CFBD data cannot answer', 'Vendor terms change'],
    tags: ['CFB', 'RECRUITING', 'SOURCE-RISK'] }),

  idea({ id: 'cfb-nil', name: 'NIL Deal Tracking / Valuation',
    category: 'talent-portal', recommendation: 'defer',
    source_headings: ['NIL Deal Tracking / NIL Valuation'],
    ...
    related_ideas: ['cfb-portal-flow', 'cfb-talent-composite'], governance: ['cfb-gov-uncertainty'],
    revisit_conditions: ['Verifiable NIL disclosure or reporting standards emerge', 'A credible dataset with known coverage appears', 'New evidence that even coarse NIL signals carry predictive lift'],
    tags: ['CFB', 'TALENT', 'MARKET', 'SOURCE-RISK'] }),

  /* ---------- Game decision engine ---------- */

  idea({ id: 'cfb-fourth-down', name: 'Fourth-Down Decision Engine',
    category: 'decision-engine', recommendation: 'build', recommendation_modifiers: ['high-priority', 'decision-engine'],
    priority: 'high', roadmap_step: 5,
    source_headings: ['Fourth-Down Decision Engine', 'Fourth-Down Yards-Gained Distribution Model'],
    components: [
      { name: 'Decision engine', source_heading: 'Fourth-Down Decision Engine',
      ...
      { name: 'Yards-gained distribution model', source_heading: 'Fourth-Down Yards-Gained Distribution Model',
    ...
    candidate_mcp_tools: ['get_fourth_down_decision'],
    ...
    dependencies: ['cfb-plays', 'cfb-team-week'], related_ideas: ['cfb-coaching-scorecards', 'cfb-counterfactual'],
    governance: ['cfb-gov-baseline'],
    ...
    tags: ['CFB', 'DECISION-ENGINE', 'MODEL', 'MCP', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-cpoe', name: 'CPOE Layer',
    category: 'decision-engine', recommendation: 'build',
    source_headings: ['CPOE'],
    ...
    dependencies: ['cfb-plays', 'cfb-player-game'], related_ideas: ['cfb-xrepa', 'cfb-qbr'],
    governance: ['cfb-gov-model-cards'], tags: ['CFB', 'MODEL'] }),

  idea({ id: 'cfb-xrepa', name: 'xREPA (Expected Rushing EPA)',
    category: 'decision-engine', recommendation: 'build',
    source_headings: ['xREPA'],
    ...
    dependencies: ['cfb-plays', 'cfb-player-game'], related_ideas: ['cfb-cpoe'],
    governance: ['cfb-gov-model-cards'], tags: ['CFB', 'MODEL'] }),

  idea({ id: 'cfb-matchup-fingerprints', name: 'Matchup Fingerprints',
    category: 'decision-engine', recommendation: 'build', recommendation_modifiers: ['high-priority', 'decision-engine'],
    priority: 'high', roadmap_step: 8,
    source_headings: ['Matchup Fingerprints'],
    ...
    candidate_mcp_tools: ['find_cfb_matchup_edges'],
    ...
    dependencies: ['cfb-unit-ratings'], related_ideas: ['cfb-fourth-down', 'cfb-fraud-detector'],
    governance: ['cfb-gov-incremental'], tags: ['CFB', 'DECISION-ENGINE', 'MCP', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-counterfactual', name: 'Counterfactual Simulator',
    category: 'decision-engine', recommendation: 'build', recommendation_modifiers: ['decision-engine'],
    source_headings: ['Counterfactual Simulator'],
    ...
    dependencies: ['cfb-ratings-registry', 'cfb-talent-composite', 'cfb-returning-production'],
    related_ideas: ['cfb-season-sim', 'cfb-portal-flow'],
    governance: ['cfb-gov-uncertainty'], tags: ['CFB', 'SIMULATION', 'DECISION-ENGINE'] }),

  /* ---------- Season / playoff decision tools ---------- */

  idea({ id: 'cfb-season-sim', name: 'Schedule Path Simulator',
    lifecycle_status: 'building', implemented: true,
    lifecycle_history: [
      { status: 'idea', on: ROADMAP_AS_OF, note: 'Entered The Pound from the 2026-08-08 CFB roadmap.' },
    ...
    components: [
      { name: 'Season Monte Carlo', source_heading: 'Schedule Path Simulator',
      ...
      { name: 'Game leverage index', source_heading: 'Game Leverage Index',
    ...
    candidate_mcp_tools: ['dd_project_cfb_schedule_path'],
    ...
    dependencies: ['cfb-ratings-registry', 'cfb-games'], related_ideas: ['cfb-counterfactual', 'cfb-prediction-markets'],
    governance: ['cfb-gov-uncertainty'],
    notes: 'Consolidation: Game Leverage Index is preserved as a derived component of the simulator rather than a separate card.',
    tags: ['CFB', 'SIMULATION', 'DECISION-ENGINE', 'MCP', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-prediction-markets', name: 'Prediction-Market Integration',
    category: 'season-simulation', recommendation: 'build', recommendation_modifiers: ['add-when-available'],
    source_headings: ['Prediction-Market Integration'],
    ...
    dependencies: ['cfb-market', 'cfb-ratings-registry'], related_ideas: ['cfb-consensus-engine'],
    tags: ['CFB', 'MARKET', 'FORECASTING'] }),
  ...
  idea({ id: 'cfb-fraud-detector', name: 'Overrated / Underrated Team Detector',
    ...
    lifecycle_history: [
      ...
      { status: 'evaluating', on: ROADMAP_AS_OF, note: 'A leakage-resistant chronological holdout found a small incremental signal beyond Elo; the one-season retrodictive result keeps the detector evaluating and does not permit team labels.' },
    ],
    delivery_evidence: ['/data/cfb-record-divergence.json', '/data/cfb-record-divergence-validation.json',
      '/scripts/cfb_record_divergence.py', '/scripts/cfb_record_divergence_validation.py',
      '/tests/test_cfb_record_divergence.py', '/tests/test_cfb_record_divergence_validation.py',
      '/work/mcp-block.js', '/work/test-mcp.mjs'],
    delivery_note: 'The descriptive baseline now has a one-season, pregame-only chronological holdout: one Elo-offset coefficient improved Brier by 0.001123 and log loss by 0.002277 over 233 untouched games. A staged read-only MCP explorer exposes the dated gaps and aggregate receipt without labels. This remains retrodictive, not market-adjusted or prospective, and does not authorize overrated/underrated team labels.',
    ...
    candidate_mcp_tools: ['dd_find_cfb_record_divergence', 'find_cfb_overrated_teams', 'find_cfb_underrated_teams'],
    ...
    dependencies: ['cfb-team-week', 'cfb-ratings-registry', 'cfb-market'],
    related_ideas: ['cfb-disagreement-lab', 'cfb-matchup-fingerprints'],
    governance: ['cfb-gov-uncertainty'], tags: ['CFB', 'MODEL', 'FORECASTING', 'MCP', 'HIGH-PRIORITY'] }),

  /* ---------- Coaching ---------- */

  idea({ id: 'cfb-coaching-lab', name: 'Coaching Networks & Transition Effects Lab',
    category: 'coaching', recommendation: 'lab',
    source_headings: ['Coaching Trees', 'Coaching Movement / Performance Delta'],
    components: [
      { name: 'Coaching trees', source_heading: 'Coaching Trees',
      ...
      { name: 'Movement / performance delta', source_heading: 'Coaching Movement / Performance Delta',
    ...
    dependencies: ['cfb-games'], related_ideas: ['cfb-coaching-scorecards'],
    governance: ['cfb-gov-incremental'],
    ...
    tags: ['CFB', 'COACHING', 'NETWORK', 'EXPERIMENTAL'] }),

  idea({ id: 'cfb-coaching-scorecards', name: 'Coaching Decision Scorecards',
    category: 'coaching', recommendation: 'build', roadmap_step: 10,
    source_headings: ['Coaching Decision Scorecards'],
    ...
    dependencies: ['cfb-fourth-down', 'cfb-plays'], related_ideas: ['cfb-coaching-lab'],
    governance: ['cfb-gov-baseline'], tags: ['CFB', 'COACHING', 'DECISION-ENGINE'] }),

  /* ---------- Contextual / environmental signals ---------- */

  idea({ id: 'cfb-context-lab', name: 'Contextual Effects Lab (Weather / Altitude / Travel / Venue)',
    category: 'context-signals', recommendation: 'lab',
    source_headings: ['Weather Effects', 'Altitude', 'Travel Distance / Time Zones', 'Indoor / Outdoor Effects'],
    components: [
      { name: 'Weather effects', source_heading: 'Weather Effects',
        summary: 'Test whether detailed weather features provide stable incremental forecast value.' },
      { name: 'Altitude', source_heading: 'Altitude',
        summary: 'Test the effect instead of assuming its magnitude.' },
      { name: 'Travel distance / time zones', source_heading: 'Travel Distance / Time Zones',
        summary: 'Test incremental value after controlling for team strength and venue.' },
      { name: 'Indoor / outdoor effects', source_heading: 'Indoor / Outdoor Effects',
    ...
    dependencies: ['cfb-games', 'cfb-team-week'], related_ideas: ['cfb-availability-lab'],
    governance: ['cfb-gov-incremental'],
    ...
    tags: ['CFB', 'EXPERIMENTAL', 'FORECASTING'] }),

  idea({ id: 'cfb-availability-lab', name: 'Injury & Availability Signals Lab',
    category: 'context-signals', recommendation: 'lab', recommendation_modifiers: ['high-potential'],
    source_headings: ['Injury / Availability Data', 'Practice Participation / Beat-Writer Proxies'],
    components: [
      { name: 'Structured injury / availability data', source_heading: 'Injury / Availability Data',
        recommendation: 'lab', summary: 'Potentially valuable, but data quality and reliable historical snapshots are major concerns. Explore trustworthy structured sources before relying on anything scraped.' },
      { name: 'Practice participation / beat-writer proxies', source_heading: 'Practice Participation / Beat-Writer Proxies',
        recommendation: 'defer', summary: 'Potential signal, but unstructured-data maintenance and historical reproducibility could be expensive. Higher source risk than structured feeds — evidence of incremental value required before productionization.' },
    ],
    ...
    dependencies: ['cfb-rosters'], related_ideas: ['cfb-context-lab', 'cfb-counterfactual'],
    governance: ['cfb-gov-incremental', 'cfb-gov-snapshotting'],
    ...
    tags: ['CFB', 'EXPERIMENTAL', 'SOURCE-RISK'] }),

  /* ---------- Alternative / weird signals ---------- */

  idea({ id: 'cfb-sentiment', name: 'Media / Reddit / Social Sentiment',
    category: 'alternative-signals', recommendation: 'defer',
    source_headings: ['Media / Reddit / Social Sentiment'],
    ...
    related_ideas: ['cfb-coaching-lab'],
    revisit_conditions: ['A cheap reproducible corpus becomes available', 'Evidence emerges that sentiment leads rather than follows results', 'A specific bounded question (e.g. coaching pressure) shows measurable lift'],
    tags: ['CFB', 'EXPERIMENTAL', 'SOURCE-RISK'] }),

  idea({ id: 'cfb-qbr', name: 'ESPN Total QBR Historical Layer',
    category: 'alternative-signals', recommendation: 'lab',
    source_headings: ['ESPN Total QBR Historical Layer'],
    ...
    dependencies: ['cfb-player-game'], related_ideas: ['cfb-cpoe'],
    governance: ['cfb-gov-incremental'], tags: ['CFB', 'MODEL', 'SOURCE-RISK'] }),
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'building', on: ROADMAP_AS_OF, note: 'Implemented and evaluated canonical game, results-only team-game, team-period and compact latest-period, and historical market lookup, generated model-card governance, rating-system discovery, bounded single-system rankings, team profile, comparison, hypothetical Elo matchup, exact hypothetical schedule-path, descriptive record-divergence, blocked model-disagreement and prospective-receipt status tools locally; all remain staged and non-callable in production.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json',
      '/data/cfb-record-divergence.json', '/data/cfb-record-divergence-validation.json', '/data/cfb-market.json',
      '/data/cfb-model-cards.json'],
    delivery_note: 'Fifteen source-backed CFB tools are implemented locally and staged, including canonical game, results-only team-game, team-period and compact latest-period, and no-CLV historical market lookup, generated model-card governance, rating-system discovery, bounded single-system rankings, exact matchup and schedule-path calculations, plus no-label divergence, blocked-study and prospective-receipt status readers. Production still has 26 live tools; deployment requires a separate approved Worker release.',
    ...
    rationale: 'The eventual product layer: read-only tools that call deterministic Data Dawgs computation, with the AI doing orchestration and explanation — the same architecture as the 26 live NFL-side tools, extended to CFB only as each underlying capability ships.',
    ...
    candidate_mcp_tools: ['dd_find_cfb_games', 'dd_find_cfb_team_games', 'dd_find_cfb_team_periods', 'dd_find_cfb_latest_team_periods', 'dd_find_cfb_historical_market', 'dd_get_cfb_model_card', 'dd_get_cfb_rating_system', 'dd_rank_cfb_teams', 'dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path', 'dd_find_cfb_record_divergence',
      'dd_get_cfb_model_disagreement', 'dd_get_cfb_model_receipt_status', 'get_cfb_model_grades', 'find_cfb_disagreements', 'get_cfb_consensus',
      'get_fourth_down_decision', 'find_cfb_matchup_edges',
      'find_cfb_overrated_teams', 'find_cfb_underrated_teams'],
    validation_requirement: 'A candidate tool goes live only after its underlying computation is built, tested and deployed — the same gate the NFL calculators passed. None of these names is callable today.',
    ...
    dependencies: ['cfb-games', 'cfb-market', 'cfb-ratings-registry', 'cfb-disagreement-lab', 'cfb-consensus-engine', 'cfb-fourth-down',
      'cfb-matchup-fingerprints', 'cfb-season-sim', 'cfb-fraud-detector', 'cfb-model-receipts', 'cfb-team-week'],
    related_ideas: ['cfb-public-outputs'],
    tags: ['CFB', 'MCP', 'API', 'FOUNDATION', 'HIGH-PRIORITY'] }),

  idea({ id: 'cfb-llm-reports', name: 'Local LLM Generated Reports',
    category: 'ai-interface', recommendation: 'not-needed',
    source_headings: ['Local LLM Generated Reports'],
    ...
    related_ideas: ['cfb-mcp-layer'],
    revisit_conditions: ['A requirement emerges that hosted models cannot serve (offline operation, private data that cannot leave the machine)', 'The existing language layer becomes unavailable'],
    tags: ['CFB', 'EXPERIMENTAL'] }),
];

/* The 61 source headings, verbatim. Tests assert every one is represented. */
const CFB_SOURCE_HEADINGS = [
...
module.exports = { ROADMAP_AS_OF, CFB_IDEAS, CFB_GOVERNANCE, CFB_ROADMAP_STEPS, CFB_LIFECYCLE, CFB_RECOMMENDATION_CLASSES, CFB_SOURCE_HEADINGS };
