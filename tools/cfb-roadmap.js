...
const CFB_IDEAS = [
  ...
  idea({ id: 'cfb-model-receipts', name: 'CFB Model Receipts / Historical Grading',
    ...
    candidate_mcp_tools: ['get_cfb_model_grades'],
  ...
  idea({ id: 'cfb-mcp-layer', name: 'Deterministic CFB MCP/API Tool Layer',
    ...
    lifecycle_history: [
      ...
      { status: 'building', on: ROADMAP_AS_OF, note: 'Implemented and evaluated team profile, comparison, hypothetical Elo matchup, exact hypothetical schedule-path, descriptive record-divergence and blocked model-disagreement evidence tools locally; all remain staged and non-callable in production.' },
    ],
    delivery_evidence: ['/work/mcp-block.js', '/work/test-mcp.mjs', '/data/cfb-ratings.json',
      '/data/cfb-record-divergence.json', '/data/cfb-record-divergence-validation.json'],
    delivery_note: 'Six source-backed CFB tools are implemented locally and staged, including exact matchup and schedule-path calculations plus no-label divergence and blocked-study evidence readers. Production still has 26 live tools; deployment requires a separate approved Worker release.',
    ...
    candidate_mcp_tools: ['dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path', 'dd_find_cfb_record_divergence',
      'dd_get_cfb_model_disagreement', 'get_cfb_model_grades', 'find_cfb_disagreements', 'get_cfb_consensus',
