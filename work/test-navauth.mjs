...
await page.screenshot({ path: "/home/claude/dd/work/shot-navauth-dark.png", clip: { x: 0, y: 0, width: 1200, height: 120 } });
await page.evaluate(() => document.documentElement.setAttribute("data-theme", "light"));
await page.waitForTimeout(150);
await page.screenshot({ path: "/home/claude/dd/work/shot-navauth-light.png", clip: { x: 0, y: 0, width: 1200, height: 120 } });
await page.setViewportSize({ width: 390, height: 844 });
await go("index.html");
await page.screenshot({ path: "/home/claude/dd/work/shot-navauth-phone.png", clip: { x: 0, y: 0, width: 390, height: 110 } });
await page.click("#ddAuthBtn");
await page.waitForTimeout(300);
await page.screenshot({ path: "/home/claude/dd/work/shot-navauth-modal.png" });
