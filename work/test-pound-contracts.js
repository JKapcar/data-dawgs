...
test('surface generator reports the deployed Pound MCP tools as live', () => {
  ...
  assert.equal(surfaces.counts.mcp_tools_staged, 12);
  ...
  assert.deepEqual(surfaces.mcp.tools_staged, ['dd_find_cfb_games', 'dd_find_cfb_team_periods', 'dd_find_cfb_historical_market', 'dd_get_cfb_model_card', 'dd_rank_cfb_teams', 'dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path', 'dd_find_cfb_record_divergence', 'dd_get_cfb_model_disagreement', 'dd_get_cfb_model_receipt_status']);
});
...
test('the implemented CFB MCP tools are staged locally but no candidate is claimed live', () => {
  ...
  const staged = new Set(['dd_find_cfb_games', 'dd_find_cfb_team_periods', 'dd_find_cfb_historical_market', 'dd_get_cfb_model_card', 'dd_rank_cfb_teams', 'dd_cfb_team_profile', 'dd_compare_cfb_teams', 'dd_project_cfb_matchup', 'dd_project_cfb_schedule_path', 'dd_find_cfb_record_divergence', 'dd_get_cfb_model_disagreement', 'dd_get_cfb_model_receipt_status']);
