...
.dt-rctop{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;gap:8px}
  ...
  function renderRC(el){
    ...
    el.innerHTML = '<div class="dt-rc">' + rs.map(function(r){
      ...
      return '<div class="dt-card'+(tied?" lead":"")+'">'
        ...
        + '<div style="font-size:10.5px;color:var(--ink-3)">'+esc(scopeLabel("rc"))+'</div></div>'
        + '<div style="text-align:right"><div class="dt-grade" style="color:'+esc(r.color)+'">'+esc(r.season?(r.m.grade||"—"):"—")+'</div>'
        + (r.season
